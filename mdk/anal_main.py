...
async def get_item_data(session, book: str):
    ...
    try:
        ...
        if in_arbat:
            ...
            all_shops = soup.find_all("div", {"class": "shop_on_map"})
            all_shops = ", ".join([i.text for i in all_shops])
...
if __name__ == "__main__":
    ...
    pd.DataFrame(all_books_result).to_excel("/media/MDK_not_in_arbat.xlsx", index=False)
